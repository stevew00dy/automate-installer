...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512">
  ...
  <!-- Eyes -->
  <circle cx="220" cy="170" r="20" fill="#1e293b"/>
  <circle cx="292" cy="170" r="20" fill="#1e293b"/>
  <circle cx="225" cy="165" r="8" fill="#60a5fa"/>
  <circle cx="297" cy="165" r="8" fill="#60a5fa"/>
  
  <!-- Smile -->
  <path d="M 210 200 Q 256 220 302 200" stroke="#1e293b" stroke-width="6" fill="none" stroke-linecap="round"/>
  
  <!-- Robot body -->
  <rect x="160" y="250" width="192" height="180" rx="25" fill="url(#bodyGradient)"/>
  
  <!-- Chest panel -->
  <rect x="210" y="290" width="92" height="80" rx="10" fill="#1e293b" opacity="0.3"/>
  ...
  <!-- Feet -->
  <ellipse cx="215" cy="485" rx="35" ry="15" fill="#1e293b"/>
  <ellipse cx="297" cy="485" rx="35" ry="15" fill="#1e293b"/>
</svg>
SVG
